...
banniere =pygame.Rect(0,0,1100,100) #definition d'une surface ou l'on affichera du texte ou le titre
...
#donner la vérification de la ligne 6: 
    if verifyline6 == True:
        ...
        y = 950 #on met le pointer sur la ligne suivante 
        verifyline6 = False
...
#donner la vérification de la ligne 7: 
    if verifyline7 == True:
        ...
        y = 1100 #on met le pointer sur la ligne suivante 
        verifyline7 = False
